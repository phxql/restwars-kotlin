...
class ApplicationInformationController(private val applicationInformationService: ApplicationInformationService) : ControllerHelper {
    fun get(): RestMethod<ApplicationInformationResponse> {
        return SimpleRestMethod(HttpMethod.GET, "/v1/restwars", ApplicationInformationResponse::class.java) { _, _ ->
