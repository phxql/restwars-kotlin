...
class FlightController(
    ...
    fun create(): RestMethod<FlightResponse> {
        return AuthenticatedPayloadRestWriteMethod(HttpMethod.POST, "/v1/planet/:location/flight", FlightResponse::class.java, CreateFlightRequest::class.java, playerService, validation) { req, _, context, payload ->
