...
Starts a colonize flight to planet 1.2.3 with 5 mosquitos and one colony ship. Cargo consists of 100 crystals and 50 gas.
...
The flight started from 1.2.3 and is a colonize flight to 4.5.6. The flight will arrive in round 112, consists of 3 mosquitos and 2 colony ships.